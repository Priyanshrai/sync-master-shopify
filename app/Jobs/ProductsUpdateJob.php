...
class ProductsUpdateJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        // Log the event
        \Log::info("Product updated in {$this->shopDomain->toNative()}: " . json_encode($productData));

        // Sync this product update to connected stores
        $this->syncProductUpdateToConnectedStores($productData);
    }

    protected function syncProductUpdateToConnectedStores($productData)
    {
