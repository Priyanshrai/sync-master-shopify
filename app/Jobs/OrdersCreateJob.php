...
class OrdersCreateJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        Log::info("Order created in {$this->shopDomain->toNative()}: " . json_encode($orderData));

        $this->syncOrderToConnectedStores($orderData);
    }

    protected function syncOrderToConnectedStores($orderData)
    {
